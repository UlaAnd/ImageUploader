...
from users.models import TierOptions, Tier
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        premium_tier = Tier.objects.create(name='Premium', originally_uploaded_image=True)
        enterprise = Tier.objects.create(name='Enterprise', originally_uploaded_image=True,  allow_fetch_expired=True)
