...
class Command(BaseCommand):
    ...
    def handle(self, *args: Any, **options: Any) -> None:
        height200, created = TierOptions.objects.get_or_create(height=200, name="200px")
        height400, created = TierOptions.objects.get_or_create(height=400, name="400px")
        ...
        enterprise, created = Tier.objects.get_or_create(
            name="Enterprise",
            allow_originally_size_image=True,
            allow_fetch_expired=True,
        )
